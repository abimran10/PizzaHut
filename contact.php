 ...
 <div class="p-3 mb-2 bg-danger text-white">
  ...
  <div class="col-0">
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white mt-1" style="">
                ...
                <form action="#" method="post">
                    ...
                    <div class="radio">
                      ...
                      <div class="col-6 col-md-4">
                        <h2 class="mr-5">Address of Business</h2>
                        <img src="pizzahutlocation.jfif" alt="" srcset="" height="300" width="150" class="image-optimized float-right">
